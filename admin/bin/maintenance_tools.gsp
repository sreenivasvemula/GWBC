...
uses gw.webservice.bc.maintenancetoolsapi.MaintenanceToolsAPI
uses gw.webservice.bc.maintenancetoolsapi.types.complex.ProcessID
...
config.ServerOverrideUrl = new URL(MaintenanceToolsArgs.Server + "/ws/gw/webservice/bc/MaintenanceToolsAPI").toURI()
...
else if ( MaintenanceToolsArgs.ImportDefaultSampleData ){
    print ( "Importing Default Sample Data...")
    api.importDefaultSampleData()
    print ( "Finished Default Sample Data Import" )
}
