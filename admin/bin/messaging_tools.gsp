...
uses java.net.URL
uses gw.webservice.bc.messagingtoolsapi.MessagingToolsAPI
...
config.ServerOverrideUrl = new URL(MessagingToolsArgs.Server + "/ws/gw/webservice/bc/MessagingToolsAPI").toURI()
