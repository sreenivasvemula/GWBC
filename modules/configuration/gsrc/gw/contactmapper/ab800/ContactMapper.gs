...
/**
 * Use this file to map between BillingCenter entities in the Contact graph and 
 * XmlBackedInstance objects that represent ContactManager entities.
 */
@Export
class ContactMapper extends ContactMapperBCBase {
  ...
  override property get Mappings() : Set<PropertyMapping> {
    ...
    // BC uses special code in BCTaxIDFieldMapping for handling TaxID.
    new BCTaxIDFieldMapping(),
