...
uses wsi.remote.gw.webservice.pc.pc700.cancellationapi.CancellationAPI
uses wsi.remote.gw.webservice.pc.pc700.cancellationapi.enums.CancellationSource
uses wsi.remote.gw.webservice.pc.pc700.cancellationapi.enums.ReasonCode
uses wsi.remote.gw.webservice.pc.pc700.policyrenewalapi.PolicyRenewalAPI

uses java.lang.IllegalStateException
uses java.util.Date

/**
 * This implementation is used for integrating with Guidewire Policy Center 7.0.
 */
@Export
class PCPolicySystemPlugin implements IPolicySystemPlugin{
  ...
  override function notifyPaymentReceivedForRenewalOffer( payment : SuspensePayment, 
    ...
    }catch(e : wsi.remote.gw.webservice.pc.pc700.policyrenewalapi.faults.BadIdentifierException){
  ...
  override function requestCancellation( policyPeriod : PolicyPeriod, 
    ...
    if(cancellationDate.after(policyPeriod.ExpirationDate)){
      ...
      }catch(e : wsi.remote.gw.webservice.pc.pc700.cancellationapi.faults.EntityStateException){
        var activity = policyPeriod.createActivity(ActivityPattern.Notification, 
  ...
  protected function callPCCancellationAPI(call : block(p : CancellationAPI)){
    ...
    try{
      call(api)
    } catch(e : wsi.remote.gw.webservice.pc.pc700.cancellationapi.faults.AlreadyExecutedException){
  ...
  protected function callPCRenewalAPI(call : block(p : PolicyRenewalAPI)){
    ...
    try{
      call(api)
    } catch(e : wsi.remote.gw.webservice.pc.pc700.policyrenewalapi.faults.AlreadyExecutedException){
      // ignore this duplicated call
    }
  } 
