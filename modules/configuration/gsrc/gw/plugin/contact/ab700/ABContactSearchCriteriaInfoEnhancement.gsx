...
enhancement ABContactSearchCriteriaInfoEnhancement : ABContactSearchCriteriaInfo {
  function sync(searchCriteria : ContactSearchCriteria){
    ...
    this.ContactType = isPerson ? wsi.remote.gw.webservice.ab.ab700.abcontactapi.enums.ABContact.ABPerson 
                                : wsi.remote.gw.webservice.ab.ab700.abcontactapi.enums.ABContact.ABCompany
