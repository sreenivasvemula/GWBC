...
// move to company
  ...
  override property get PrimaryAddressCityKanji() : String {
  ...
  override property get PrimaryAddressLine1Kanji() : String {
  ...
  override property get PrimaryAddressLine2Kanji() : String {
  ...
  override property get PrimaryAddressCEDEX() : Boolean {
    return _contact.PrimaryAddress.CEDEX
  }

  override property get PrimaryAddressCEDEXBureau() : String {
   return _contact.PrimaryAddress.CEDEXBureau
  }
