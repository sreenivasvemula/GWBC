...
x.t("level","package");
x.t("term","search");
x.t("billingcenter/modules/configuration/config/locale/en_us","however");
x.t("upon","save");
x.t("enter","open");
x.t("enter","localized");
...
x.t("page","error");
x.t("location","billingcenter/modules/configuration/config/locale/en_us");
x.t("ctrl","type");
