...
else if (Guidewire_TopicMatch(TOPIC,"Guidewire BillingCenter\u00ae") && Guidewire_FMSourceFileMatch(SRCFILE,"cover-suite.html") ) { return "cover-suite.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"InsuranceSuite Features") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-features.html") ) { return "suite-features.html";}
else if (Guidewire_TopicMatch(TOPIC,"InsuranceSuite Integration") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-impl.4.1.html") ) { return "suite-impl.4.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Integrating ClaimCenter and PolicyCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-impl.4.2.html") ) { return "suite-impl.4.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Integrating BillingCenter and PolicyCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-impl.4.3.html") ) { return "suite-impl.4.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Integrating ContactManager with Guidewire Core Applications") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-impl.4.4.html") ) { return "suite-impl.4.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Integrating ClaimCenter with BillingCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-impl.4.5.html") ) { return "suite-impl.4.5.html";}
