...
else if (Guidewire_TopicMatch(TOPIC,"Gosu Primitive Types") && Guidewire_FMSourceFileMatch(SRCFILE,"intro.03.10.html") ) { return "intro.03.10.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Legal Variable Names") && Guidewire_FMSourceFileMatch(SRCFILE,"intro.03.15.html") ) { return "intro.03.15.html";}
else if (Guidewire_TopicMatch(TOPIC,"Gosu Generated Documentation (Gosudoc)") && Guidewire_FMSourceFileMatch(SRCFILE,"intro.03.16.html") ) { return "intro.03.16.html";}
else if (Guidewire_TopicMatch(TOPIC,"Code Coverage Support") && Guidewire_FMSourceFileMatch(SRCFILE,"intro.03.17.html") ) { return "intro.03.17.html";}
else if (Guidewire_TopicMatch(TOPIC,"Notable Differences Between Gosu and Java") && Guidewire_FMSourceFileMatch(SRCFILE,"intro.03.18.html") ) { return "intro.03.18.html";}
else if (Guidewire_TopicMatch(TOPIC,"Get Ready for Gosu") && Guidewire_FMSourceFileMatch(SRCFILE,"intro.03.19.html") ) { return "intro.03.19.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Array List Access with Array Index Notation") && Guidewire_FMSourceFileMatch(SRCFILE,"datatypes.04.08.html") ) { return "datatypes.04.08.html";}
else if (Guidewire_TopicMatch(TOPIC,"Entity Arrays and Their Automatic Methods") && Guidewire_FMSourceFileMatch(SRCFILE,"datatypes.04.09.html") ) { return "datatypes.04.09.html";}
else if (Guidewire_TopicMatch(TOPIC,"Associative Array Syntax for Property Access") && Guidewire_FMSourceFileMatch(SRCFILE,"datatypes.04.10.html") ) { return "datatypes.04.10.html";}
else if (Guidewire_TopicMatch(TOPIC,"Numeric Literals") && Guidewire_FMSourceFileMatch(SRCFILE,"datatypes.04.11.html") ) { return "datatypes.04.11.html";}
else if (Guidewire_TopicMatch(TOPIC,"Entity Types") && Guidewire_FMSourceFileMatch(SRCFILE,"datatypes.04.12.html") ) { return "datatypes.04.12.html";}
else if (Guidewire_TopicMatch(TOPIC,"Typekeys and Typelists") && Guidewire_FMSourceFileMatch(SRCFILE,"datatypes.04.13.html") ) { return "datatypes.04.13.html";}
else if (Guidewire_TopicMatch(TOPIC,"Compatibility with Earlier Gosu Releases") && Guidewire_FMSourceFileMatch(SRCFILE,"datatypes.04.14.html") ) { return "datatypes.04.14.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Handling Exceptions with trycatchfinally") && Guidewire_FMSourceFileMatch(SRCFILE,"exceptionhandling.07.2.html") ) { return "exceptionhandling.07.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Throwing Exceptions") && Guidewire_FMSourceFileMatch(SRCFILE,"exceptionhandling.07.3.html") ) { return "exceptionhandling.07.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Object Lifecycle Management (using Clauses)") && Guidewire_FMSourceFileMatch(SRCFILE,"exceptionhandling.07.4.html") ) { return "exceptionhandling.07.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Assert Statements") && Guidewire_FMSourceFileMatch(SRCFILE,"exceptionhandling.07.5.html") ) { return "exceptionhandling.07.5.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Enabling Context Comments in Queries on SQL Server") && Guidewire_FMSourceFileMatch(SRCFILE,"querybuilder.10.36.html") ) { return "querybuilder.10.36.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Paths and Restriction Builders") && Guidewire_FMSourceFileMatch(SRCFILE,"querybuilder.10.42.html") ) { return "querybuilder.10.42.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Basic Type Coercion") && Guidewire_FMSourceFileMatch(SRCFILE,"typesystem.24.3.html") ) { return "typesystem.24.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Basic Type Checking") && Guidewire_FMSourceFileMatch(SRCFILE,"typesystem.24.4.html") ) { return "typesystem.24.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"Using Reflection") && Guidewire_FMSourceFileMatch(SRCFILE,"typesystem.24.5.html") ) { return "typesystem.24.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Compound Types") && Guidewire_FMSourceFileMatch(SRCFILE,"typesystem.24.6.html") ) { return "typesystem.24.6.html";}
else if (Guidewire_TopicMatch(TOPIC,"Type Loaders") && Guidewire_FMSourceFileMatch(SRCFILE,"typesystem.24.7.html") ) { return "typesystem.24.7.html";}
