...
x.t("/child2","/element1");
x.t("/child2","child2");
x.t("billingcenter/modules/configuration/gsrc/mycompany/schemas","gosu");
x.t("performs","slight");
x.t("name=","home");
x.t("name=","phone");
x.t("name=","cell");
...
x.t("path","root");
x.t("path","billingcenter/modules/configuration/gsrc/mycompany/schemas");
...
x.t("billingcenter/modules/configuration/gsrc","example");
x.t("cannot","create");
x.t("cannot","assign");
x.t("cannot","xsd");
...
x.t("words","suppose");
x.t("powerful","xml");
x.t("starting","billingcenter/modules/configuration/gsrc");
