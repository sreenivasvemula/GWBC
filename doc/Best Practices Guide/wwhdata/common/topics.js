...
else if (Guidewire_TopicMatch(TOPIC,"Guidewire BillingCenter\u00ae") && Guidewire_FMSourceFileMatch(SRCFILE,"cover-bestpractice.html") ) { return "cover-bestpractice.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"User Interface Best Practices") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.01.html") ) { return "bp-user-interface.4.01.html";}
else if (Guidewire_TopicMatch(TOPIC,"Page Configuration Best Practices") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.02.html") ) { return "bp-user-interface.4.02.html";}
else if (Guidewire_TopicMatch(TOPIC,"Display Keys Best Practices") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.03.html") ) { return "bp-user-interface.4.03.html";}
else if (Guidewire_TopicMatch(TOPIC,"Use Display Keys to Display Text") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.04.html") ) { return "bp-user-interface.4.04.html";}
else if (Guidewire_TopicMatch(TOPIC,"Create Unique Display Keys") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.05.html") ) { return "bp-user-interface.4.05.html";}
else if (Guidewire_TopicMatch(TOPIC,"Use Placeholder Variables in Display Keys for Variable Data Only") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.06.html") ) { return "bp-user-interface.4.06.html";}
else if (Guidewire_TopicMatch(TOPIC,"Avoid Insertion of One Display Key into Another Display Key") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.07.html") ) { return "bp-user-interface.4.07.html";}
else if (Guidewire_TopicMatch(TOPIC,"Observe Display Key Naming Conventions") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.08.html") ) { return "bp-user-interface.4.08.html";}
else if (Guidewire_TopicMatch(TOPIC,"Add a Suffix to New Display Keys to Avoid Name Conflicts") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.09.html") ) { return "bp-user-interface.4.09.html";}
else if (Guidewire_TopicMatch(TOPIC,"Organize Display Keys by Page Configuration Component") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.10.html") ) { return "bp-user-interface.4.10.html";}
else if (Guidewire_TopicMatch(TOPIC,"User Interface Performance Best Practices") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.11.html") ) { return "bp-user-interface.4.11.html";}
else if (Guidewire_TopicMatch(TOPIC,"Avoid Post on Change and Client Reflection for Page Refreshes") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.12.html") ) { return "bp-user-interface.4.12.html";}
else if (Guidewire_TopicMatch(TOPIC,"Avoid Repeated Calculations of Expensive Widget Values") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.13.html") ) { return "bp-user-interface.4.13.html";}
else if (Guidewire_TopicMatch(TOPIC,"Avoid Expensive Calculations of Widget Properties") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.14.html") ) { return "bp-user-interface.4.14.html";}
else if (Guidewire_TopicMatch(TOPIC,"Use Application Permission Keys for Visibility and Editability") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.15.html") ) { return "bp-user-interface.4.15.html";}
else if (Guidewire_TopicMatch(TOPIC,"User Interface Best Practices Checklist") && Guidewire_FMSourceFileMatch(SRCFILE,"bp-user-interface.4.16.html") ) { return "bp-user-interface.4.16.html";}
